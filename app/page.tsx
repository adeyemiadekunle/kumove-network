...
export default function HomePage() {
  return <SiteFrame>
    <section className="hero" aria-labelledby="home-heading"><div className="container-wide hero-grid"><div><div className="eyebrow reveal">Delivery, redrawn</div><h1 className="reveal delay-1" id="home-heading">Your city,<br /><em>in motion.</em></h1><p className="hero-copy reveal delay-2">KuMove is the delivery network that makes online orders feel local — pairing brilliant businesses with trusted people, smarter routes and the places you already know.</p><div className="hero-actions reveal delay-3"><Link className="button-primary" href="/business" data-testid="button-partner-with-kumove">For business <ArrowDownRight size={16} /></Link><Link className="button-quiet" href="/about" data-testid="button-see-the-route">See the route</Link></div><div className="hero-note"><span className="pulse" />Built for the rhythm of real neighborhoods</div></div><NetworkVisual /></div></section>
    <Ticker />
